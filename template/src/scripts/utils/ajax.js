...
export function post (endPoint, requestData, options, config) {
  ...
  return $.ajax(merge({
    ...
    contentType: requestData instanceof FormData ? false : (typeof requestData === 'string' ? 'application/jsoncharset=utf-8' : 'application/x-www-form-urlencodedcharset=utf-8'),

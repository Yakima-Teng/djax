...
:注意: **也就是说，如果你打算开发诸如后台管理系统之类的网站的话，Djax并不适合。此类网站不需要考虑SEO，同时表单和列表比较多, 那么还是建议你使用Vue/React/Angular或者其他类似的MVWhateveryoulike框架。此类网站通常js代码量较大，需要借助这些框架来对代码结构进行一些有益的限制。**
